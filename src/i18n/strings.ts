...
const en: Strings = {
  ...
  homeSub: 'Preset games — Sebeeta, Kout, Trix — plus an open scorepad for everything else.',
...
const ar: Strings = {
  ...
  homeSub: 'ألعاب جاهزة — سبيته، كوت، ترِكس — وقيد مفتوح لأي لعبة ثانية.',
  ...
  // ── ترِكس ────────────────────────────────────────────────────
  gameTrix: 'ترِكس',
  gameTrixDesc: 'ممالك من الالعاب. الأقل نقاطًا يفوز — الالعاب تُضيف وتركس يخصم.',
  gameTrixMeta: '٤ لاعبين · ٤ ممالك',
  trixHint: 'ترِكس: ٤ لاعبين، ٤ ممالك. كل ملك يلعب الالعاب الخمسة مرة. الأقل نقاطًا يفوز.',
  trixKingOfHearts: 'باش الحاس',
  trixQueens: 'ميمات',
  trixDiamonds: 'ديامن',
  trixTricks: 'اكلات',
  trixTrix: 'ترِكس',
  ...
  trixPenaltyDeal: 'الالعاب',
  trixLadderDeal: 'تركس',
  trixSelectContracts: 'أي لعبه؟ (تُلعب معًا)',
  trixCapturerLabel: 'من أخذ باش الحاس؟',
